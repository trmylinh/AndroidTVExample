...
import com.example.androidtvexample.custom_view.CustomSearchSupportFragment
import com.example.androidtvexample.custom_view.SearchResultProvider


class VoiceSearchFragment : CustomSearchSupportFragment(),
    ...
    fun setRecognitionListener() {
        ...
        if (!hasPermission(Manifest.permission.RECORD_AUDIO)) {
            ...
            setSpeechRecognitionCallback{
                try {
                    this@VoiceSearchFragment.startActivityForResult(
                        recognizerIntent,
                        REQUEST_SPEECH
                    )
