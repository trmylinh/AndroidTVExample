...
//        badgeDrawable = resources.getDrawable(R.mipmap.ic_launcher, null)
        // over title
    ...
    private fun loadRows() {
        ...
        /* GridItemPresenter */
        val gridHeader = HeaderItem(0, "GridItemPresenter")
        ...
        for (i in 0 until NUM_ROWS) {
            ...
            movie.cardImageUrl = "https://commondatastorage.googleapis.com/android-tv/Sample%20videos/Zeitgeist/Zeitgeist%202010_%20Year%20in%20Review/card.jpg"
